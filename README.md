...
| `TENKI_API_KEY`                  | tenki.cloud credential (`tk_…`) for the tenki sandbox provider (used with `--provider tenki`).                                                   |
