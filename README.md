...
| `TENKI_API_KEY`                  | tenki.cloud credential (`tk_…`) enabling the tenki sandbox provider.                                                                             |
